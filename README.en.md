...
`anvillib-test-neoforge-1.21.6` is a development/testing module and is not part of the aggregate runtime artifact.
...
dependencies {
    ...
    implementation "dev.anvilcraft.lib:anvillib-wheel-neoforge-1.21.6:2.0.0"
}
```
