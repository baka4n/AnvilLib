...
[![NeoForge](https://img.shields.io/badge/NeoForge-21.3.x-orange.svg)](https://neoforged.net/)
...
`anvillib-test-neoforge-1.21.3` is a development/testing module and is not part of the aggregate runtime artifact.
...
dependencies {
    ...
    implementation "dev.anvilcraft.lib:anvillib-codec-neoforge-1.21.3:2.0.0"
    ...
    implementation "dev.anvilcraft.lib:anvillib-wheel-neoforge-1.21.3:2.0.0"
}
```
