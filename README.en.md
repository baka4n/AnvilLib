...
[![Maven Central](https://img.shields.io/maven-central/v/dev.anvilcraft.lib/anvillib-neoforge-1.21.7)](https://central.sonatype.com/search?q=anvillib)
[![NeoForge](https://img.shields.io/badge/NeoForge-21.7.x-orange.svg)](https://neoforged.net/)
...
`anvillib-neoforge-1.21.7` is the aggregate artifact. It bundles and re-exports:
...
`anvillib-test-neoforge-1.21.7` is a development/testing module and is not part of the aggregate runtime artifact.
...
dependencies {
    // Full library
    implementation "dev.anvilcraft.lib:anvillib-neoforge-1.21.7:2.0.0"

    // Or import individual modules as needed
    implementation "dev.anvilcraft.lib:anvillib-config-neoforge-1.21.7:2.0.0"
    implementation "dev.anvilcraft.lib:anvillib-codec-neoforge-1.21.7:2.0.0"
    implementation "dev.anvilcraft.lib:anvillib-integration-neoforge-1.21.7:2.0.0"
    implementation "dev.anvilcraft.lib:anvillib-network-neoforge-1.21.7:2.0.0"
    implementation "dev.anvilcraft.lib:anvillib-recipe-neoforge-1.21.7:2.0.0"
    implementation "dev.anvilcraft.lib:anvillib-moveable-entity-block-neoforge-1.21.7:2.0.0"
    implementation "dev.anvilcraft.lib:anvillib-registrum-neoforge-1.21.7:2.0.0"
    implementation "dev.anvilcraft.lib:anvillib-wheel-neoforge-1.21.7:2.0.0"
}
```
